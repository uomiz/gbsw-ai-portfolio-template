...
2. 각 폴더에 `project.json` (필수)과 `README.md` (선택) 작성
...
cat data/projects/interlocutor-adaptation/README.md
```
...
#### 4-3. README.md 작성 (선택사항)

`data/projects/sentiment-analysis/README.md` 파일 생성:

```markdown
# 한국어 감정 분석 모델

## 프로젝트 개요
BERT 기반 한국어 감정 분석 모델
...
README.md는 향후 더 자세한 포트폴리오 페이지를 만들 때 활용할 수 있습니다!
...
### Q6. README.md는 꼭 작성해야 하나요?
A. 선택사항입니다. 나중에 프로젝트 상세 페이지를 만들 때 활용할 수 있지만, 지금은 `project.json`만 작성해도 충분합니다.
...
### Q8. projects.json을 직접 수정하면 안 되나요?
